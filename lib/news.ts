...
export const newsItems: NewsItem[] = [
  ...
  },
  {
    ...
    image: "/images/common/news-mimora-open.jpg",
    body: "本日、キッズ用品セレクトストア「MIMORA」がオープンいたしました。子供服・ベビー用品を厳選してラインナップし、コーディネート提案やランキングから選べる買い物体験をお届けします。皆さまのご利用を心よりお待ちしております。",
  },
];
